import {
  ...
  y,
  zl
} from "./chunk-GT4RWEJN.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  clsx_default
} from "./chunk-OHLVBHXM.js";
import "./chunk-JQNEHNVF.js";
import {
  require_jsx_runtime
} from "./chunk-VXCDF2R5.js";
import "./chunk-OJ64Z5HW.js";
import {
  require_react_dom
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks?.map((mark, index3) => (0, import_react199.createElement)(
    "div",
    {
...
var Timeline = factory((_props, ref) => {
  ...
  const items = _children.map(
    (item, index3) => (0, import_react431.cloneElement)(item, {
      unstyled,
      __align: align,
...
var oe = (e) => (0, import_jsx_runtime344.jsxs)(Stack, { gap: 0, className: "bn-tooltip", children: [
...
var O = (0, import_react441.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    Vo(S, false);
    const [x, y2] = (0, import_react441.useState)(false), k = o ? (0, import_jsx_runtime344.jsx)(
      Button,
      {
        "aria-label": g,
        className: t,
    ...
    return r ? (0, import_jsx_runtime344.jsx)(
      Tooltip,
      {
        disabled: x,
        withinPortal: false,
...
var Re = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    text: o,
    icon: r,
  ...
  Vo(g, false);
  const [b, S] = (0, import_react441.useState)(false), x = (0, import_jsx_runtime344.jsxs)(
    Chip,
    {
      className: t,
      checked: i === true,
      ...
      ref: n,
      children: [
        (0, import_jsx_runtime344.jsx)("span", { children: r }),
        (0, import_jsx_runtime344.jsx)("span", { children: o })
      ]
    }
  );
  return !a || b ? x : (0, import_jsx_runtime344.jsx)(
    Tooltip,
    {
      refProp: "rootRef",
      withinPortal: false,
...
var Be = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: o });
});
var Ee = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    headerText: r,
  ...
  Vo(u, false);
  const g = (0, import_react441.useRef)(null);
  return (0, import_react441.useEffect)(() => {
    var b;
    i && ((b = g.current) == null || b.scrollIntoView({
      behavior: "smooth",
      block: "center"
    }));
  }, [i]), (0, import_jsx_runtime344.jsxs)(
    Card,
    {
      ...
      ref: To([n, g]),
      children: [
        r && (0, import_jsx_runtime344.jsx)(Text, { className: "bn-header-text", children: r }),
        o
      ]
    }
  );
});
var Le = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r, false), (0, import_jsx_runtime344.jsx)(Card.Section, { className: t, ref: n, children: o });
});
var ze = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r, false), (0, import_jsx_runtime344.jsx)(
    Divider,
    {
      className: t,
...
var je = (0, import_react441.forwardRef)((e, n) => {
  const { authorInfo: t, timeString: o, edited: r, ...i } = e, a = y();
  return Vo(i, false), t === "loading" ? (0, import_jsx_runtime344.jsxs)(Group, { children: [
...
var $e = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    showActions: o,
    authorInfo: r,
  ...
  return Vo(u, false), (0, import_jsx_runtime344.jsxs)(Group, { pos: "relative", ref: y2, className: t, children: [
    l && (o === true || o === void 0 || o === "hover" && g || S) ? (0, import_jsx_runtime344.jsx)(
      Group,
      {
        ref: x,
        style: {
    ...
    (0, import_jsx_runtime344.jsx)(je, { ...e }),
    c
  ] });
});
var Ae = (0, import_react441.forwardRef)((e, n) => {
...
var _e = () => {
  ...
  return (0, import_jsx_runtime344.jsx)(Bt, { blockTypeSelectItems: [], children: e });
};
var Ve = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r,
  ...
  return Vo(w), (0, import_jsx_runtime344.jsx)(
    TextInput,
    {
      size: "xs",
      className: U(
...
var Ge = (0, import_react441.createContext)(void 0);
var He = (e) => {
  const { children: n, onOpenChange: t, position: o, sub: r, ...i } = e;
  return Vo(i), r ? (0, import_jsx_runtime344.jsx)(
    Menu.Sub,
    {
...
var Ke = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r, checked: i, subTrigger: a, onClick: l, ...c } = e;
  return Vo(c, false), a ? (0, import_jsx_runtime344.jsx)(
    Menu.Sub.Item,
    {
      className: t,
      ref: n,
      leftSection: r,
      rightSection: i ? (0, import_jsx_runtime344.jsx)(CheckIcon, { size: 10 }) : i === false ? (0, import_jsx_runtime344.jsx)("div", { className: "bn-tick-space" }) : null,
      onClick: l,
      ...c,
      children: o
    }
...
var Ue = (e) => {
  ...
  return Vo(o), t ? (0, import_jsx_runtime344.jsx)(Menu.Sub.Target, { children: n }) : (0, import_jsx_runtime344.jsx)(Menu.Target, { children: n });
};
var We = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    sub: r,
  ...
  Vo(i);
  const a = (0, import_react441.useContext)(Ge);
  return r ? (0, import_jsx_runtime344.jsx)(
    Menu.Sub.Dropdown,
    {
      className: t,
...
var qe = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return Vo(o), (0, import_jsx_runtime344.jsx)(Menu.Divider, { className: t, ref: n });
});
var Ze = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime344.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var Je = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
  ...
  return Vo(g, false), r ? (0, import_jsx_runtime344.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var Qe = (0, import_react441.forwardRef)((e, n) => {
  ...
  return Vo(c), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime344.jsxs)(
    Tabs,
    {
      value: i,
      defaultValue: r,
      ...
      children: [
        ...
        (0, import_jsx_runtime344.jsx)(Tabs.List, { children: o.map((u) => (0, import_jsx_runtime344.jsx)(
          Tabs.Tab,
          {
        ...
        o.map((u) => (0, import_jsx_runtime344.jsx)(Tabs.Panel, { value: u.name, children: u.tabPanel }, u.name))
      ]
    }
  ) });
});
var Xe = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r, label: i, ...a } = e;
  return Vo(a), (0, import_jsx_runtime344.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": i,
...
var Ye = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r, placeholder: i, onChange: a, ...l } = e;
  return Vo(l), (0, import_jsx_runtime344.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var et = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime344.jsx)("div", { className: t, ref: n, children: o });
});
var tt = (0, import_react441.forwardRef)((e, n) => {
...
var nt = (e) => {
  ...
  return Vo(r), (0, import_jsx_runtime344.jsx)(Popover, { withinPortal: false, opened: n, position: t, children: o });
};
var ot = (e) => {
  const { children: n, ...t } = e;
  return Vo(t), (0, import_jsx_runtime344.jsx)(PopoverTarget, { children: n });
};
var rt = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r,
  ...
  return Vo(i), (0, import_jsx_runtime344.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var st = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r, false), (0, import_jsx_runtime344.jsx)(
    Group,
    {
...
var it = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
...
var at = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, id: r, ...i } = e;
  return Vo(i), (0, import_jsx_runtime344.jsx)(
    Stack,
    {
      gap: 0,
      className: t,
...
var lt = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime344.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var ct = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: a, ...l } = e;
  Vo(l);
  const c = (0, import_react441.useRef)(null);
  return (0, import_react441.useEffect)(() => {
    if (!c.current || !o)
      return;
    const u = zl(
    ...
    Group,
    {
      ...
      children: [
        i.icon && (0, import_jsx_runtime344.jsx)(
          Group,
          {
        ...
        (0, import_jsx_runtime344.jsxs)(Stack, { gap: 0, className: "bn-mt-suggestion-menu-item-body", children: [
          (0, import_jsx_runtime344.jsx)(Text, { className: "bn-mt-suggestion-menu-item-title", children: i.title }),
          (0, import_jsx_runtime344.jsx)(Text, { className: "bn-mt-suggestion-menu-item-subtitle", children: i.subtext })
        ] }),
        i.badge && (0, import_jsx_runtime344.jsx)(
          Group,
          {
            "data-position": "right",
            className: "bn-mt-suggestion-menu-item-section",
            children: (0, import_jsx_runtime344.jsx)(Badge, { size: "xs", children: i.badge })
          }
        )
      ]
    }
...
var ut = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: o });
});
var dt = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return Vo(o), (0, import_jsx_runtime344.jsx)(Loader, { className: t, type: "dots", size: 16, ref: n });
});
var mt = (0, import_react441.forwardRef)((e, n) => {
...
var ft = (0, import_react441.forwardRef)((e, n) => {
...
var gt = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: a, ...l } = e;
  Vo(l);
  const c = (0, import_react441.useRef)(null);
  return (0, import_react441.useEffect)(() => {
...
var bt = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
...
var ht = (0, import_react441.forwardRef)((e, n) => {
  const { children: t, className: o, onMouseDown: r, onClick: i, ...a } = e;
  return Vo(a, false), (0, import_jsx_runtime344.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var pt = (0, import_react441.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r,
  ...
  return Vo(u, false), (0, import_jsx_runtime344.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var D = (0, import_react441.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
...
var G = import_react441.default.createContext && import_react441.default.createContext(re);
...
function se(e) {
  return e && e.map((n, t) => import_react441.default.createElement(n.tag, M({
    key: t
  }, n.attr), se(n.child)));
}
function Nt(e) {
  return (n) => import_react441.default.createElement(Tt, F2({
    attr: M({}, e.attr)
  }, n), se(e.child));
}
function Tt(e) {
  var n = (t) => {
    ...
    return t.className && (c = t.className), e.className && (c = (c ? c + " " : "") + e.className), import_react441.default.createElement("svg", F2({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, a, {
      ...
      width: l,
      xmlns: "http://www.w3.org/2000/svg"
    }), i && import_react441.default.createElement("title", null, i), e.children);
  };
  return G !== void 0 ? import_react441.default.createElement(G.Consumer, null, (t) => n(t)) : n(re);
}
function kt(e) {
...
var I = (0, import_react441.forwardRef)((e, n) => {
  const { className: t, items: o, isDisabled: r, ...i } = e;
  Vo(i);
  const a = o.filter((l) => l.isSelected)[0];
  return a ? (0, import_jsx_runtime344.jsxs)(
    Menu,
    {
      withinPortal: false,
      transitionProps: {
      ...
      children: [
        (0, import_jsx_runtime344.jsx)(Menu.Target, { children: (0, import_jsx_runtime344.jsx)(
          Button,
          {
            ...
            leftSection: a.icon,
            rightSection: (0, import_jsx_runtime344.jsx)(kt, {}),
            size: "xs",
            variant: "subtle",
            disabled: r,
            children: a.text
...
var Ft = (e) => {
  const { className: n, theme: t, ...o } = e, r = F(), i = jr(), a = (r == null ? void 0 : r.colorSchemePreference) || i, l = (0, import_react441.useCallback)(
    (b) => {
    ...
    [a, t]
  ), c = (0, import_react441.useContext)(MantineContext), u = typeof t == "string" ? t : a !== "no-preference" ? a : "light", g = (0, import_jsx_runtime344.jsx)(Tn.Provider, { value: Pt, children: (0, import_jsx_runtime344.jsx)(
    Ll,
    {
  ...
  return c ? g : (0, import_jsx_runtime344.jsx)(
    MantineProvider,
    {
